...
export const products: Product[] = [
  {
    ...
    tagline: "One dashboard for every dollar, every month.",
    description: desc("Smart Budget Spreadsheet", "zero-based monthly budgeting"),
    price: 21,
    sale_price: 10.5,
    ...
    rating_avg: 4.9,
    review_count: 1284,
    tags: ["budget", "monthly", "excel", "google sheets"],
    is_bundle: false,
    bundle_components: [],
    is_plr: false,
    best_seller: true,
